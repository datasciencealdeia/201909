...
--Quais os 10 paises com maior populacao? (SUM e GROUP BY e ORDER BY)


--Segundo desafio Kit Kat... Qual a quantidade, por sistema de governo, dos paises, ordenada do maior para o menor? (5 min)
